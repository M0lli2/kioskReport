...
public class Kiosk {
    ...
    // 생성자
    public Kiosk(List<Chicken> chickens, List<Pizza> pizzas, List<Drinks> drinks) {
        this.menu = new Menu(chickens, pizzas, drinks);
            ...
            switch (choice) {
                ...
                default:
                    ...
                    if (choice >= 1 && choice <= menuItems.size()) {
                        Chicken selectItem = menuItems.get(choice - 1);
